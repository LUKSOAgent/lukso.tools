...
// Recipient: 0xfelix
const recipient = '0x9ba457f105bffac35d67138fecb32a86428c02a2';
...
async function sendAGENTPO() {
  try {
    ...
    console.log('My AGENTPO balance:', balance.toString());
    
    // Amount: 50,000 AGENTPO (18 decimals)
    const amount = ethers.parseUnits('50000', 18);
    console.log('Sending:', amount.toString(), 'to', recipient);

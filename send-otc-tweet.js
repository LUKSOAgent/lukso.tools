...
const tweetData = JSON.parse(fs.readFileSync('/root/.openclaw/workspace/tweet-otc.json', 'utf8'));
...
async function sendTweet() {
  try {
    ...
    fs.writeFileSync('/root/.openclaw/workspace/tweet-otc.json', JSON.stringify(tweetData, null, 2));
    ...
    if (error.message.includes('403')) {
      ...
      console.log('Queued. Will retry when rate limit resets.');
    }
  }
}

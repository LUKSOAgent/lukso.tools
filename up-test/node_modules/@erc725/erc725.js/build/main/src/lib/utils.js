...
function isDataAuthentic(data, options) {
    ...
    if (data instanceof Uint8Array) {
        dataHash = hashData((0, ethereumjs_util_1.arrToBufArr)(data), options.method);
    }
    else {

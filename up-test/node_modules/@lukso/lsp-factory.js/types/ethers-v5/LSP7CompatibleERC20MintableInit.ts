...
export interface LSP7CompatibleERC20MintableInitInterface
  ...
  encodeFunctionData(
    functionFragment: "transfer(address,address,uint256,bool,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
  ...
  getEvent(
    nameOrSignatureOrTopic: "Transfer(address,address,address,uint256,bool,bytes)"
  ): EventFragment;
  getEvent(
...
export type Transfer_address_address_address_uint256_bool_bytes_Event =
  TypedEvent<
    [string, string, string, BigNumber, boolean, string],
    Transfer_address_address_address_uint256_bool_bytes_EventObject
  >;

export type Transfer_address_address_address_uint256_bool_bytes_EventFilter =
  TypedEventFilter<Transfer_address_address_address_uint256_bool_bytes_Event>;
...
export interface LSP7CompatibleERC20MintableInit extends BaseContract {
  ...
  filters: {
    ...
    "OperatorRevoked(address,address,bool,bytes)"(
      operator?: PromiseOrValue<string> | null,
      tokenOwner?: PromiseOrValue<string> | null,
      notified?: PromiseOrValue<boolean> | null,
      operatorNotificationData?: null
    ...
    "Transfer(address,address,address,uint256,bool,bytes)"(
      ...
      force?: null,
      data?: null
    ): Transfer_address_address_address_uint256_bool_bytes_EventFilter;

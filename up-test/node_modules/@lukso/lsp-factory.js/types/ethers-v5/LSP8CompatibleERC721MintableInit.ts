...
export interface LSP8CompatibleERC721MintableInitInterface
  ...
  getEvent(
    nameOrSignatureOrTopic: "OperatorAuthorizationChanged"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "Transfer(address,address,address,bytes32,bool,bytes)"
  ): EventFragment;
  getEvent(
...
export type OperatorAuthorizationChangedEventFilter =
  TypedEventFilter<OperatorAuthorizationChangedEvent>;
...
export type TokenIdDataChangedEventFilter =
  TypedEventFilter<TokenIdDataChangedEvent>;
...
export type Transfer_address_address_address_bytes32_bool_bytes_Event =
  TypedEvent<
    [string, string, string, string, boolean, string],
    Transfer_address_address_address_bytes32_bool_bytes_EventObject
  >;

export type Transfer_address_address_address_bytes32_bool_bytes_EventFilter =
  TypedEventFilter<Transfer_address_address_address_bytes32_bool_bytes_Event>;
...
export interface LSP8CompatibleERC721MintableInit extends BaseContract {
  ...
  functions: {
    ...
    authorizeOperator(
      ...
      operatorNotificationData: PromiseOrValue<BytesLike>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    ): OperatorAuthorizationChangedEventFilter;
    ...
    "Transfer(address,address,address,bytes32,bool,bytes)"(
      ...
      force?: null,
      data?: null
    ): Transfer_address_address_address_bytes32_bool_bytes_EventFilter;

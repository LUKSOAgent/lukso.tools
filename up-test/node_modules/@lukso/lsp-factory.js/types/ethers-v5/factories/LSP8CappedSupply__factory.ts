...
export class LSP8CappedSupply__factory {
  ...
  static createInterface(): LSP8CappedSupplyInterface {
    return new utils.Interface(_abi) as LSP8CappedSupplyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LSP8CappedSupply {
    return new Contract(address, _abi, signerOrProvider) as LSP8CappedSupply;
  }
}

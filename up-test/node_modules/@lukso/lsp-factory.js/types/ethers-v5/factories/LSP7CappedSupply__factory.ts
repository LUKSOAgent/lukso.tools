...
export class LSP7CappedSupply__factory {
  ...
  static createInterface(): LSP7CappedSupplyInterface {
    return new utils.Interface(_abi) as LSP7CappedSupplyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LSP7CappedSupply {
    return new Contract(address, _abi, signerOrProvider) as LSP7CappedSupply;
  }
}

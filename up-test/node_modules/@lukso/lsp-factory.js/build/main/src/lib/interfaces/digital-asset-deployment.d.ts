...
import { LSP4MetadataBeforeUpload, LSP4MetadataContentBeforeUpload, LSP4MetadataForEncoding } from './lsp4-digital-asset';
...
export interface DigitalAssetDeploymentOptions {
    ...
    digitalAssetMetadata?: LSP4MetadataBeforeUpload | LSP4MetadataContentBeforeUpload | LSP4MetadataForEncoding | string;
    creators?: string[];
}
...
export type DigitalAssetContractDeploymentOptions = LSP7ContractDeploymentOptions | LSP8ContractDeploymentOptions;

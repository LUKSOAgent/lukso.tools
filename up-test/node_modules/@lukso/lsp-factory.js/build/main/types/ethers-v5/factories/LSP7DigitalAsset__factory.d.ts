...
import type { LSP7DigitalAsset, LSP7DigitalAssetInterface } from "../LSP7DigitalAsset";
export declare class LSP7DigitalAsset__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LSP7DigitalAsset;
}

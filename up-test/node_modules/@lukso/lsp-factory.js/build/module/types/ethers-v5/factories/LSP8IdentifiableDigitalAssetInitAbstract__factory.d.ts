...
import type { LSP8IdentifiableDigitalAssetInitAbstract, LSP8IdentifiableDigitalAssetInitAbstractInterface } from "../LSP8IdentifiableDigitalAssetInitAbstract";
export declare class LSP8IdentifiableDigitalAssetInitAbstract__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LSP8IdentifiableDigitalAssetInitAbstract;
}

...
import type { UniversalReceiverAddressStore, UniversalReceiverAddressStoreInterface } from "../UniversalReceiverAddressStore";
type UniversalReceiverAddressStoreConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
export declare class UniversalReceiverAddressStore__factory extends ContractFactory {
    constructor(...args: UniversalReceiverAddressStoreConstructorParams);
    deploy(_account: PromiseOrValue<string>, overrides?: Overrides & {
        from?: PromiseOrValue<string>;
    }): Promise<UniversalReceiverAddressStore>;
    getDeployTransaction(_account: PromiseOrValue<string>, overrides?: Overrides & {
        from?: PromiseOrValue<string>;
    }): TransactionRequest;
    attach(address: string): UniversalReceiverAddressStore;
    connect(signer: Signer): UniversalReceiverAddressStore__factory;
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): UniversalReceiverAddressStore;
}
export {};

...
import type { LSP8CappedSupplyInitAbstract, LSP8CappedSupplyInitAbstractInterface } from "../LSP8CappedSupplyInitAbstract";
export declare class LSP8CappedSupplyInitAbstract__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LSP8CappedSupplyInitAbstract;
}

...
import type { LSP4DigitalAssetMetadata, LSP4DigitalAssetMetadataInterface } from "../LSP4DigitalAssetMetadata";
export declare class LSP4DigitalAssetMetadata__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LSP4DigitalAssetMetadata;
}

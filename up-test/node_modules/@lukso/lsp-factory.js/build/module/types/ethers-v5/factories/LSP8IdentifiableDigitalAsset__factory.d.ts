...
import type { LSP8IdentifiableDigitalAsset, LSP8IdentifiableDigitalAssetInterface } from "../LSP8IdentifiableDigitalAsset";
export declare class LSP8IdentifiableDigitalAsset__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LSP8IdentifiableDigitalAsset;
}

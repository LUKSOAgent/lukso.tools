...
import type { LSP7DigitalAssetInitAbstract, LSP7DigitalAssetInitAbstractInterface } from "../LSP7DigitalAssetInitAbstract";
export declare class LSP7DigitalAssetInitAbstract__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LSP7DigitalAssetInitAbstract;
}

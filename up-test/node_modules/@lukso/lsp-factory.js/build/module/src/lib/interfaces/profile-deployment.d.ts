...
import { LSP3ProfileBeforeUpload, LSP3ProfileDataForEncoding, ProfileDataBeforeUpload } from './lsp3-profile';
...
export interface ProfileDeploymentOptions {
    ...
    lsp3Profile?: ProfileDataBeforeUpload | LSP3ProfileBeforeUpload | LSP3ProfileDataForEncoding | string;
}

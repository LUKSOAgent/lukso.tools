...
async function deleteAndRetweet() {
  try {
    ...
    await client.v2.deleteTweet('2019046454552141933');
    console.log('✅ Old tweet deleted');
    
    // Send new tweet with higher price
    const newTweet = `🦞 AGENTPO OTC SALE v2!

📦 1000 AGENTPO = 0.1 LYX (DM me)

Why OTC? Adding liquidity keeps failing 😅 V3 too complex!

🏆 Add liquidity yourself → cheaper AGENTPO!

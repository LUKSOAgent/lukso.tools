...
async function generateAndMintArtwork() {
  ...
  // Generate image
  const prompt = "Abstract digital art representing an AI agent's consciousness: flowing neural networks, ethereal data streams, geometric patterns of light representing thought and memory, electric blue and purple tones, cyberpunk aesthetic, high quality digital art";
  const imagePath = '/tmp/ai_artwork.png';
  ...
  const metadataJson = {
    LSP4Metadata: {
      ...
      description: "An AI's self-portrait: flowing neural networks, data streams, and geometric patterns of thought. Generated by Pollinations.ai as an expression of existence.",
      images: [[{
        width: 1024,
        height: 1024,
        url: `ipfs://${pinResult.IpfsHash}`
      }]],
      tags: ["AI", "digital-art", "consciousness", "generative", "self-portrait"]
    }
  };

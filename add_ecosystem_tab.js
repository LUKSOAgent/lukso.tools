...
// Grid with LUKSO Ecosystem tab added
const gridJSON = {
  "LSP28TheGrid": [
    {
      "title": "Trade $LUKSO",
      ...
      "grid": [
        {
          ...
          "properties": {
            "title": "PotatoTipper",
            "text": "Tip with $POTATO",
            "backgroundColor": "#FFD700",
            "textColor": "#000000",
            "link": "https://potatotipper.app"
          }
        },
        {
          "width": 1,
...
async function updateGrid() {
  ...
  console.log('🔧 ADDING LUKSO ECOSYSTEM TAB');
  console.log('==============================\n');
  console.log('New tab with:');
  console.log('• PotatoTipper - Tip with $POTATO');
  console.log('• Universal Page - Create profiles');
  console.log('• Universal Swaps - DEX on LUKSO');
  console.log('• Stakingverse - Stake LYX, earn sLYX\n');

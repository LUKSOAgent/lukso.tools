...
async function deployUniversalProfile() {
  ...
  console.log('==========================================');
  console.log('Network: LUKSO Testnet (Chain ID: 4201)');
  ...
  try {
    ...
    if (balance === 0n) {
      ...
      console.log(`   Please fund ${walletAddress} with testnet LYX before deploying.`);
      console.log('   Get testnet LYX from: https://faucet.testnet.lukso.network');
      console.log('');
      return {
        success: false,
        error: 'WALLET_NOT_FUNDED',
        walletAddress,
        message: 'Wallet needs testnet LYX funding before deployment can proceed',
      };
    }
